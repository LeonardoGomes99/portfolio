        ...
        <nav className="fixed top-0 left-0 w-full bg-[#1B1B1F] text-white z-50 shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex space-x-6">
                        ...
                        <a href="#contact-section" className="hover:text-gray-300"><b>Contato</b></a>
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden bg-[#1B1B1F] px-4 py-2 space-y-2">
                    <a href="#introduction-section" className="block hover:text-gray-300"><b>Sobre Mim</b></a>
                    <a href="#timeline-section" className="block hover:text-gray-300"><b>Trajetória Profissional e Acadêmica</b></a>
                    <a href="#certifications-section" className="block hover:text-gray-300"><b>Certificações</b></a>
                    <a href="#projects-section" className="block hover:text-gray-300"><b>Projetos</b></a>
                    <a href="#contact-section" className="block hover:text-gray-300"><b>Contato</b></a>
                </div>
            )}
        </nav>
    );
